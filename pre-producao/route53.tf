...
# resource "aws_route53_record" "projeto-preprod-record" {
#     for_each = {
#         for dvo in aws_acm_certificate.projeto-preprod-certificate.domain_validation_options : dvo.domain_name => {
